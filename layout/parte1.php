...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link rel="stylesheet"
    href="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/plugins/fontawesome-free/css/all.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/dist/css/adminlte.min.css">

  <!-- DataTables -->
  <link rel="stylesheet"
    href="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet"
    href="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet"
    href="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
  ...
  <div class="wrapper">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/dist/img/esteban.jpeg" alt="Usuario"
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/dist/img/user3-128x128.jpg"
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?php echo $URL; ?>" class="brand-link">
        <img src="<?php echo $URL; ?>/public/images/logoMINIMARKET.png" alt="Ventas Online"
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="<?php echo $URL; ?>/public/template/AdminLTE-3.2.0/dist/img/esteban.jpeg"
              class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a href="#" class="d-block"><?php echo $nombres; ?></a>
            <!--Llamo la variable en php que me trae el nombre de la persona que inició sesión-->
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item"> <!--quito el menu open para que no quede abierto siempre-->
            <a href="#" class="nav-link active">
              <i class="nav-icon fas fa-tags"></i> <!-- fa-tachometer-alt" lo cambio por lo que está actualmente -->
              <p>
                Categorías <!--cambio el nombre a USUARIOS antes Starter pages-->
                <i class="right fas fa-angle-leftfa"></i>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo $URL; ?>../categorias/listado_categorias.php" class="nav-link"> <!--quito el active page para que no aparezca blanco en la página ppal 
                  y cambio el # por la ruta de usuarios-->
                  <i class="far fa-circle nav-icon"></i>
                  <p>Listado de Categorías</p> <!-- puedo cambiarlo por; Listado de Usuarios -->
                </a>
              </li>
            </ul>
            </li>
            ...
            <li class="nav-item"> <!--quito el menu open para que no quede abierto siempre-->
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo $URL; ?>../productos/index.php" class="nav-link"> <!--quito el active page para que no aparezca blanco en la página ppal 
                  y cambio el # por la ruta de usuarios-->
                    <i class="far fa-circle nav-icon"></i>
            ...
            <!--Botón cerrar sesión-->
            <li class="nav-item">
              <a href="<?php echo $URL; ?>/app/controladores/login/cerrar_sesion.php" class="nav-link"
                style="background-color: red"> <!--añadimos un estilo, la ruta de cerrar sesión la pego
